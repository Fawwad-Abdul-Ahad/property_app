...
class House2Details extends StatefulWidget {
  const House2Details({super.key});

  @override
  State<House2Details> createState() => _House2DetailsState();
}


class _House2DetailsState extends State<House2Details> {
  final String houseTitle1 = "CRAFTSMAN HOUSE 1";
  toggleWIshlist(){
    if(isInWishlist(houseTitle1)){
      removeFromWishlist(houseTitle1);
    }
    else{
      addToWishlist(houseTitle1);
    }
  }
  @override
  Widget build(BuildContext context) {
  bool isfavourite = isInWishlist(houseTitle1); 
    return Scaffold(
      body: SafeArea(
        child: Container(
